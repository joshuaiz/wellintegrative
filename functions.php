...
function bones_fonts() {
  wp_enqueue_style('googleFonts', 'http://fonts.googleapis.com/css?family=Open+Sans:400,700,400italic');
}
...
function gcic_testimonials_cpt() {
  ...
  $args = array(
    'label'               => __( 'gcic_testimonials', 'text_domain' ),
  ...
  register_post_type( 'gcic_testimonials', $args );

}

// Hook into the 'init' action
add_action( 'init', 'gcic_testimonials_cpt', 0 );
